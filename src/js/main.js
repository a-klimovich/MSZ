    ...
    const scheamContetn = [
      {
        title: "О ЗАВОДЕ",
        text:
          "Работаем с 1939 <br><br> Открытое акционерное общество «Кобринский маслодельно-сыродельный завод» это предприятие с 80-летним опытом работы и уникальными традициями производства. Мы с гордостью можем вспомнить каждый год работы завода. Нам есть, о чем рассказать и чем гордиться!",
        href: "#a",
      },
      {
        title: "ПРОИЗВОДСТВО",
      ...
      },
      {
        title: "ПОЛИТИКА",
        text:
          "Работаем с 1939 <br><br> <b> Открытое акционерное общество «Кобринский</b> маслодельно-сыродельный завод»",
        href: "#d",
      },
    ];
